...
state_vector_values = []
ts = []
state_vector = np.array([0,n_HII_initial , n_e_initial, 0, n_HeII_initial, n_HeIII_initial, n_HM_initial, 0, 0, T0,n_total,e*((gamma-1)*mh),0,safety])
...
state_vector = np.array([0,n_HII_initial , n_e_initial, 0, n_HeII_initial, n_HeIII_initial, n_HM_initial, 0, 0, T0,n_total,e*((gamma-1)*mh),dt,safety])
